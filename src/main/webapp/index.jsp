                ...
                <div class="py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                    ...
                    <div class="relative -mr-40 pl-6 sm:mx-auto sm:max-w-3xl sm:px-0 lg:h-full lg:max-w-none lg:pl-12">
                        <img class="w-full rounded-md shadow-xl ring-1 ring-black ring-opacity-5 lg:h-full lg:w-auto lg:max-w-none"
                             src="https://cdn.discordapp.com/attachments/1161000798650630235/1165975381799612446/Capture_decran_20231023_122942.png?ex=6548ce31&is=65365931&hm=afc5929575822e8f8538d8d6284b1e8b4844010694a49ca140cacc43a187afc2&"
                             alt="">
                    </div>
                </div>
            </div>
